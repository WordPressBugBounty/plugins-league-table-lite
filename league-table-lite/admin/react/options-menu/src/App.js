...
const App = () => {
  ...
  useEffect(() => {
     ...
     */
    wp.apiFetch({
      path: '/league-table-lite/v1/read-options',
      method: 'POST'
    }).
        then(data => {
  ...
  function handleSave(e) {
    ...
    wp.apiFetch({
      path: '/league-table-lite/v1/options',
      method: 'POST',
      data: {
        ...options
      },
        ...
        <React.StrictMode>

          {
            ...
            <>
              ...
              <div className="daextletal-body-container">
            ...
            :
            <LoadingScreen
                loadingDataMessage={__('Loading data...', 'league-table-lite')}
            />
        }
