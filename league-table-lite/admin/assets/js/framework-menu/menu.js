	...
	function ($) {
		...
		$( document.body ).on(
			...
			function () {
				...
				$( '.daextletal-main-form__daext-form-section-body[data-section-id="' + target + '"]' ).toggleClass( 'daextletal-main-form__daext-form-section-body-opened' );
		...
		$( document.body ).on(
			'mouseenter',
			'.daextletal-admin-toolbar__menu-item-more',
			function () {
				$( '.daextletal-admin-toolbar__pop-sub-menu' ).show();
			}
		);

		$( document.body ).on(
			'mouseleave',
			'.daextletal-admin-toolbar__menu-item-more, .daextletal-admin-toolbar__pop-sub-menu',
			function () {
				$( '.daextletal-admin-toolbar__pop-sub-menu' ).hide();
			}
		);
		...
		$( document ).on(
			'change',
			'.daextletal-bulk-action-checkbox',
			function () {
				let selectedItems = [];
				$( '.daextletal-bulk-action-checkbox:checked' ).each(
					function () {
