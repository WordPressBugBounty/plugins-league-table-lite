...
class Daextletal_Pagination {
	 ...
	 * Constructor.
	 *
	 * @param Daextletal_Shared $shared Instance of the shared class.
	 */
	...
	public function show() {
		...
		if ( $last_page > 1 ) {
			...
			echo '<div class="daextletal-crud-table-controls__pagination-paging-text">' .
				esc_html( $this->current_page ) .
				'&nbsp' .
				esc_html__( 'of', 'league-table-lite' ) .
				'&nbsp' .
				esc_html( $last_page ) .
				'</div>';
